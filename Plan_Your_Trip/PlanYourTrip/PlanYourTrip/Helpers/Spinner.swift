...
//  PlanYourTrip
//
//  Created by Wisly Juganda on 3/9/23.
//
...
struct Spinner: View {
    ...
    let rotationTime: Double = 0.35
    let animationTime: Double = 1.0 // Sum of all animation times
    ...
    var body: some View {
        ZStack {
            ...
            // S1
            SpinnerCircle(start: spinnerStart, end: spinnerEndS1, rotation: rotationDegreeS1, color: .indigo)
        }
